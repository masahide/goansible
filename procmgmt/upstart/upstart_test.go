...
func TestInstall(t *testing.T) {
	...
	res, err := goansible.RunAdhocTask("upstart/install", opts)
	if err != nil {
		panic(err)
	}
...
func TestDaemon(t *testing.T) {
	...
	res, err := goansible.RunAdhocTask("upstart/daemon", opts)
	if err != nil {
		panic(err)
	}
...
func TestTaskScripts(t *testing.T) {
	...
	res, err := goansible.RunAdhocTask("upstart/task", opts)
	if err != nil {
		panic(err)
	}
...
func TestRestart(t *testing.T) {
	...
	res, err := goansible.RunAdhocTask("upstart/restart", opts)
	if err != nil {
		panic(err)
	}
...
func TestStop(t *testing.T) {
	...
	res, err := goansible.RunAdhocTask("upstart/stop", opts)
	if err != nil {
		panic(err)
	}
...
func TestStart(t *testing.T) {
	...
	res, err := goansible.RunAdhocTask("upstart/start", opts)
	if err != nil {
		panic(err)
	}
...
func TestStartWithEnv(t *testing.T) {
	...
	res, err := goansible.RunAdhocTaskVars(td)
	if err != nil {
		panic(err)
	}
