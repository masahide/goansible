...
func TestAptDryRun(t *testing.T) {
	...
	res, err := goansible.RunAdhocTask("apt", "pkg=acct dryrun=true")
	if err != nil {
		panic(err)
	}
...
func TestAptInstallAndRemoves(t *testing.T) {
	...
	res, err := goansible.RunAdhocTask("apt", "pkg=acct")
	if err != nil {
		panic(err)
	}
	...
	res2, err := goansible.RunAdhocTask("apt", "pkg=acct")
	if err != nil {
		panic(err)
	}
	...
	res3, err := goansible.RunAdhocTask("apt", "pkg=acct state=absent")
	if err != nil {
		panic(err)
	}
	...
	res4, err := goansible.RunAdhocTask("apt", "pkg=acct state=absent")
	if err != nil {
		panic(err)
	}
